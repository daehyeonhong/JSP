...
<form action="postCodeProcess.jsp" method="post">
	...
	<div>
		<label>우편번호: </label><input type="text" id="postcode" name="postcode"
			placeholder="우편번호" />
	</div>
	<div>
	...
	<div>
		<label>상세 주소:</label> <input type="text" id="detailAddress"
			name="detailAddress" placeholder="상세주소" />
	</div>
	<div>
		<label>참고 항목</label> <input type="text" id="extraAddress"
